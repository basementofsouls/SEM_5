...
int main()
{
	...
	processes[0] = createProcess(L"E:\\כאבû\\־ׁ\\lab6\\laba_6\\laba_6\\Debug\\task05A.exe").hProcess;
	processes[1] = createProcess(L"E:\\כאבû\\־ׁ\\lab6\\laba_6\\laba_6\\Debug\\task05B.exe").hProcess;
