...
/*
Это объявление функции loop, которая будет выполняться в каждом созданном потоке. 
Она принимает аргумент displayed_name, который будет выводиться в сообщениях.
*/
