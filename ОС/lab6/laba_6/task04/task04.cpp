...
int main()
{
	...
	processes[0] = createProcess(L"E:\\כאבû\\־ׁ\\lab6\\laba_6\\laba_6\\Debug\\task04A.exe").hProcess;
	processes[1] = createProcess(L"E:\\כאבû\\־ׁ\\lab6\\laba_6\\laba_6\\Debug\\task04B.exe").hProcess;
