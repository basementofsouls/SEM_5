...
{	
	//Задание 2
		CPaintDC dc(this);//Конструирует объект, готовит окно приложения для рисования и сохраняет
	...
	case ID_ABOUT:
		dc.TextOutW(600, 300, CString("Created By Samsonik A.I."));
		break;
	}
}
...
BEGIN_MESSAGE_MAP(CMainWin, CFrameWnd)
	...
	ON_COMMAND(ID_ABOUT, &CMainWin::About)
	ON_WM_PAINT()
END_MESSAGE_MAP()